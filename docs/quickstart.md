...
1. Open the PMS in your browser.
...
After login you land on the **Dashboard**. From here you can:
...
1. Go to **Reservation** in the sidebar.
...
1. Ensure the **room** is ready: in **Housekeeping**, the room should be **Vacant Clean** (or Ready). Change status if needed.
2. Open the reservation (from **Reservation** or **Front Desk → Room plan** or **In-House**).
...
1. For **Cashiering**, log in to a **cash register** first if prompted (**Cash Register Login**).
2. Go to **Cashiering → Transaction**.
3. **Select the reservation** you just checked in. Its **guest folio** opens.
