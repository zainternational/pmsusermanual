...
- [Rate Categories](/configuration/rate-setup/rate-categories) — Finer grouping within a class.
- [Rates](/configuration/rate-setup/rates) — Individual rate plans linked to a class and category.
